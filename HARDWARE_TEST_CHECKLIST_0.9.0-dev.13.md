# Hardware Test Checklist - 0.9.0-dev.13

Release: `0.9.0`  
Build: `0.9.0-dev.13`

- [ ] `/json/info` reports `release=0.9.0` and `build=0.9.0-dev.13`.
- [ ] Start a multi-image Carousel upload.
- [ ] The red arrow moves downward only into the blue tray.
- [ ] The activity bar is visually separated from the tray.
...
- [ ] At upload completion, the activity segment does not fill to 100%; it disappears when Carousel playback begins.
